...
"""
From: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/contrib/distributions/python/ops/seed_stream.py
This is needed by hidden_markov_model, and was only added in tf r1.8 (and we use 1.7 for Edward)
"""
